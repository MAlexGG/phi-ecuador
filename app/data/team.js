export const team = [
    {
        ...
        name: 'Investigadora principal: Inés del Pino Martínez',
        description: 'Doctora en Arte y Arquitectura por la Universidad Nacional de Colombia; Máster en Gobierno de la Ciudad con mención en Áreas Históricas por FLACSO-Ecuador; Máster en Estudios de la Cultura, mención Comunicación por Universidad Andina Simón Bolívar-Ecuador; Arquitecta, Profesora investigadora de la Pontificia Universidad Católica del Ecuador.',
        job: 'Coordinadora Ecuador',
        link: 'https://scholar.google.com/citations?user=7UUdnioAAAAJ&hl=es',
        image: '/img/members/ines.jpg'
    },
    {
